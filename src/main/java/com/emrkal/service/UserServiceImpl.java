...
/**
 * User {@link com.emrkal.model.User} modeline ait servis sınıfıdır.
 * <p>
 * 
 * @see UserService
 * @version 1.0
...
public class UserServiceImpl implements UserService, UserDetailsService {
	...
	private org.springframework.security.core.userdetails.User buildUserForAuth(com.emrkal.model.User user, List<SimpleGrantedAuthority> auth) {
