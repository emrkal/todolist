...
/**
 * Activity {@link com.emrkal.model.Activity} modeline ait "Persistence"
...
public interface ActivityRepository extends JpaRepository<Activity, Long> {
	...
	/**
	 * Activity {@link com.emrkal.model.Activity} modeli üzerindeki tüm
	 * kayıtların StartDate alanına göre order yapılarak döndürülmesi sağlanır.
	 * <p>
	 * 
	 * @version 1.0
	 * @return {@link com.emrkal.model.Activity}
	 * @author Emrullah KALKAN
	 */
	List<Activity> findAllByUserOrderByStartDateAsc(User user);

	/**
	 * Activity {@link com.emrkal.model.Activity} modelinde statusu
	 ...
	 * @author Emrullah KALKAN
	 */
	@Query("SELECT a FROM Activity a WHERE a.endDate < CURRENT_DATE and a.user= :user and a.status!= com.emrkal.enums.ToDoStatus.DONE")
	List<Activity> findAllByUserOrderByEndDateAsc(@Param("user") User user);

	/**
	 * Activity {@link com.emrkal.model.Activity} modelindeki statusu,
	 ...
	 * {@link com.emrkal.model.Activity} bilgisi döndürülür.
	 * <p>
	 * 
	 * @param id
	 * @param user
	 ...
	 * {@link com.emrkal.model.Activity} kayıtlarının toplam sayı bilgisi
	 * döndürülür.
	 * <p>
	 * 
	 * @param doStatus
